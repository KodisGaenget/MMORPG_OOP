...
namespace GameLib
{
    public class RoomHandler
    {
        ...
        private void CreateRooms()
        {
            ...
            allRooms.Add(new Room(6, "Kitchen", "You open the door to the kitchen and notice three giant rats trying to haul away large wheels of cheese. The bad part is that they noticed you as well and have now dropped their cheese to charge towards you {Insert 3 giant rats}. {There is one door to your left and one door straight ahead}. ", "In one of the cupboard you notice a glass flask, you pick it up and gain {1 medium health potion}", 8, 0, 5, 7));
            ...
            allRooms.Add(new Room(8, "Stairway", "'Not much to see in here, only a stairway up to the second floor'.{One door to the right}", "Room Examine string", 11, 9, 6, 0));
